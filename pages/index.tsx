    ...
    <div>
      ...
      <div>
        ...
        <div className="mt-3 ml-6">
          ...
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">Кудайберген</p>
        </div>
        <div className="mt-3 ml-6">
          <p className="pb-[5px] text-[9px]">Имя</p>
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">Тимур</p>
        </div><div className="mt-3 ml-6">
          <p className="pb-[5px] text-[9px]">Отчество</p>
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">Рустемулы</p>
        </div>
        <div className="mt-3 ml-6">
          <p className="pb-[5px] text-[9px]">Фамилия транскриптом</p>
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">Kudaibergen</p>
        </div>
        <div className="mt-3 ml-6">
          <p className="pb-[5px] text-[9px]">Имя транскриптом</p>
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">Timur</p>
        </div>
        <div className="mt-3 ml-6">
          <p className="pb-[5px] text-[9px]">Отчество транскриптом</p>
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">Rustemuly</p>
        </div>
        <div className="mt-3 ml-6">
          <p className="pb-[5px] text-[9px]">ИИН</p>
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">050525515418</p>
        </div>
        <div className="mt-3 ml-6">
          <p className="pb-[5px] text-[9px]">Дата рождения</p>
          <p className="border border-[#3498db] w-[290px] px-3 py-2 rounded-[3px] bg-[#eee]">25.05.2005</p>
        </div>
        <div className="mt-3 ml-6">
